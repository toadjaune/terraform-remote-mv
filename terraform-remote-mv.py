...
for resource in resource_names:
    ...
    subprocess.run(["terraform", "state", "mv", "-state=source.tfstate", "-state-out=dest.tfstate", resource, resource], check=True)
...
print(f"Removing ./source.tfstate")
os.remove("source.tfstate")
print(f"Removing ./dest.tfstate")
os.remove("dest.tfstate")
